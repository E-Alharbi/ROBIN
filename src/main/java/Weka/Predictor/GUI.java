	    		   ...
	    		   String [] arg= {MTZ};
					try {
						...
						jt.setText(Pre.PredictionTable);
						 ...
						 j.setModel(model1);
						ResoVal.setText(String.valueOf(Pre.ResoToUseInGUI));
						RMSDVal.setText(String.valueOf(Pre.cfftM.RMSD));
						SkewVal.setText(String.valueOf(Pre.cfftM.Skew));
						MinVal.setText(String.valueOf(Pre.cfftM.Min));
						MaxVal.setText(String.valueOf(Pre.cfftM.Max));
			    	   ...
			    	   public void actionPerformed(ActionEvent e){  
			    		   ...
			    		   String [] arg= {MTZ};
							try {
								...
								Parameters.instanceValue1	=new double[]{ Double.parseDouble(RMSDVal.getText()), Double.parseDouble(SkewVal.getText()), Double.parseDouble(ResoVal.getText()),Double.parseDouble(MaxVal.getText()),Double.parseDouble(MinVal.getText())}; 
								Predict Pre = new Predict();
								Pre.main(arg);
								System.out.println("Pre "+Pre.PredictionTable);
								jt.setText(Pre.PredictionTable);
